              ...
              <div class="box-tools">
                <form action="<?php echo base_url('ticket/ticketList/skeyword'); ?>" method="post" >
                  <div class="input-group input-group-sm" style="width: 150px;">
                    <input type="text" name="table_search" class="form-control pull-right" placeholder="Ticket ile Ara...">
                 ...
                 foreach ($tickets as $Ticket){ ?>
                    ...
                    <td style="width: 10%"><?php echo $Ticket->ticketID; ?></td>
                      ...
                      <div class="btn-group-horizantal">
                        <a href="<?php echo base_url("ticket/ticketList/add/".$Ticket->ticketID); ?>" type=button class="btn btn-success"><i class="fa fa-reply-all"></i></a>
                        <a href="<?php echo base_url("ticket/ticketList/edit/".$Ticket->ticketID); ?>" type=button class="btn btn-warning"><i class="fa fa-edit"></i></a>
                        <a type="button" class="btn btn-danger" href="javascript:;" onclick="return confirm_Action('<?php echo base_url(); ?>ticket/ticketList/delete/<?php echo $Ticket->ticketID; ?>');" ><i class="fa fa-trash"></i></a>
                      </div>
                    </td>
                </tr>
               <?php }
